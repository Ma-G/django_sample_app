...
from todo.models import TodoItem as TodoIt 
...
class TestCreateTodoItem(APITestCase):
    ...
    def test_item_was_created(self):
        self.assertEqual(TodoIt.objects.count(), 1)

    def test_item_has_correct_title(self):
        self.assertEqual(TodoIt.objects.get().title, 'Walk the dog')
...
class TestUpdateTodoItem(APITestCase):
    ...
    def setUp(self):
        ...
        self.assertEqual(TodoIt.objects.get().completed, False)
    ...
    def test_item_was_updated(self):
        self.assertEqual(TodoIt.objects.get().completed, True)
...
class TestDeleteTodoItem(APITestCase):
    ...
    def test_the_item_was_deleted(self):
        self.assertEqual(TodoIt.objects.count(), 0)
...
class TestDeleteAllItems(APITestCase):
    ...
    def setUp(self):
        ...
        createItem(self.client)
        self.assertEqual(TodoIt.objects.count(), 2)
